...
int main() {
	...
	for (unsigned int ada = 0; ada < 50; ++ada) {
        cout << spitEulerSquare(ada) << ", ";
    }cout << endl;

	// test sqrt(8)
    cout << "Integers in the sequence of sqrt(8): " << endl;
    ...
    printCF(sqrt2, 10);
    /*cout << "Square root of 2 ignored: " << endl;
    sqrt2 = fractionalPart(sqrt2);
    printCF(sqrt2, 10);*/
    ...
    cout << "30/13 as a continued fraction: ";
    printCF(thrithyOverThirteen, 20);
    cout << "125/13 as a continued fraction: ";
    auto one25OverThirteen = getCF(125,13);
    printCF(one25OverThirteen, 20);
    cout << "125/13 using the magic box as 5 + 2 * 30/13: ";
    auto one25OverThirteen2 = getCFUsingMB(thrithyOverThirteen, 5, 2, 15);
